# Macaulay Consulting — Content Copy

This file is the source of truth for all page copy on the Macaulay Consulting website. When content changes, update this file and the corresponding HTML page at the same time.

**How to use:** each section below maps to a page. Copy is presented in the order it appears on the page. Placeholders and items awaiting Caroline's input are marked `[PLACEHOLDER]` or `[CAROLINE TO CONFIRM]`.
...
**Heading:** What a well-facilitated process looks like

**Card 1 — A room that thinks together**
Strategic planning sessions where the whole leadership team genuinely contributes — not just the loudest voices in the room.

**Card 2 — Services built with users**
Co-design processes that bring together staff, service users and stakeholders to create something grounded in actual experience.

**Card 3 — Evidence that informs decisions**
Qualitative evaluation that captures what the data alone misses — the stories, patterns and insights that drive better choices.

**Card 4 — A team that wants to come to work**
Culture programmes that give teams a shared language and practical tools to build environments where people feel connected and energised.
...
**05 — More Joy at Work**
A structured team culture programme built on emotional culture research and neuro-leadership — for teams who want to feel better about the work they do together.
...
**Heading:** Organisations Caroline has worked with

*Client logos/names are managed via `clients.json`. Set `confirmed: true` per client to display the logo.*
...
Every engagement begins with a no-obligation call. Tell Caroline what you're working on and she'll tell you honestly whether she can help.
...
### Hero
**Eyebrow:** About Caroline

**Heading:** At the heart of this work is a belief in what becomes possible when people *come together with intention.*
...
Her desire to improve how essential services are designed and delivered led her to a second career in health strategy, where she spent years co-designing and implementing human-centred services and programmes at scale across Queensland.

In 2023, Caroline established Macaulay Consulting to bring that experience directly to organisations navigating change. She draws on a background in strategy, planning, service improvement, innovation and leadership, combined with qualifications in neuro-leadership, emotional culture and psychological safety, to create conditions where real change becomes possible.

Her work spans Queensland Health, West Moreton Health, Children's Health Queensland, the Department of the Premier and Cabinet, yourtown, Brisbane South PHN, the Lung Foundation, and a number of other health and public sector organisations.

**Link:** See recent work → /case-studies
...
**Heading:** How Caroline works

Caroline's approach is shaped by emotional intelligence, brain science and decades of practical experience working inside complex organisations. She is direct without being prescriptive, structured without being rigid, and consistently described by clients as someone who makes difficult conversations feel manageable.

She works flexibly: scoping each engagement to what is actually needed rather than fitting clients into a standard package. Engagements can range from a single facilitated session to a multi-month strategic programme.

Whether the work is a strategic planning process, a facilitated workshop, or a sustained team culture programme, Caroline brings the same commitment to listening, clarity and practical action.
...
### CTA
**Heading:** Want to know if Caroline is the right fit?

The best way is a conversation. No pitch, no pressure.
...
### How we work (values, on dark section)
**Eyebrow:** How we work
...
**Subheading:** A selection of recent engagements — shared with client permission.

---

### Intro
**Eyebrow:** A selection of recent engagements

**Heading:** What the work looks like in practice

---

### Case Study 1 — West Moreton Health *(needs Caroline's confirmation before publishing)*

**Meta:** Strategic Planning Facilitation · West Moreton Hospital and Health Service

**Heading:** Paving the way for significant change at West Moreton Health

**The situation**
West Moreton Hospital and Health Service was facing a period of significant organisational change and needed to engage its leadership team in a structured process that would build alignment, surface key challenges and set a clear direction for the road ahead.

**What we did**
Caroline designed and facilitated a series of workshops for the West Moreton leadership team, drawing on her knowledge of the Queensland health system and her expertise in structured facilitation. The process was designed to engage everyone in the room — not just senior voices — and to keep the group focused on the issues that actually mattered.
...
### Case Study 3 `[PLACEHOLDER — awaiting content from Caroline]`

---

### Case Study 4 `[PLACEHOLDER — awaiting content from Caroline]`

---

### CTA
**Heading:** Want to talk about your own project?

Every engagement starts with a conversation. No pitch, no pressure — just an honest discussion about whether this kind of work could help.

**Primary CTA:** Get in touch → /contact

**Secondary CTA:** See all services → /services

---

## More Joy at Work (`more-joy-at-work.html`)

### Hero
**Heading:** More Joy *at Work.*

**Subheading:** A programme for teams who want to feel better about the work they do together.

**CTA:** Let's talk about your team → tel:+61404014117
...
**Heading:** More than team-building.

Most teams don't lack goodwill. What they often lack is a shared language for talking about how they work together, and a structured way to do something about it.

More Joy at Work gives teams both. Drawing on emotional culture research, neuro-leadership frameworks and Caroline's experience working with dozens of teams across the health and public sector, the programme helps people understand what shapes their experience at work and take practical steps to improve it.

This is not a one-off team-building day. It is a considered approach to culture that meets teams where they are and helps them move, together, toward something better.

**Link:** See all services from Macaulay Consulting → /services
...
`[CAROLINE TO CONFIRM — please review the phase names, sequence and descriptions below. These are based on the Emotional Culture Deck methodology and existing site content. Expand, rename or restructure to match how you actually deliver the programme.]`

**Phase 1 — Culture Assessment**
The team explores how they currently feel about their work and what is shaping that experience. This draws on validated emotional culture tools and is facilitated with care and psychological safety.

**Phase 2 — Shared Language**
The team develops a common understanding of the emotions and values that matter to them, and begins to articulate the culture they want to build.

**Phase 3 — Practical Action**
The team identifies specific, manageable commitments they can make to one another. These are grounded in daily work, not aspirational statements.

*The programme is available as a standalone engagement or as part of a broader organisational change process.*

---

### Ideas behind the work
**Eyebrow:** Ideas behind the work

**Heading:** Explore the thinking

Caroline shares short videos on the research, thinking and practical tools behind the programme.

**Link:** Follow on LinkedIn → https://www.linkedin.com/in/caroline-macaulay-91b2689b/

`[PLACEHOLDER — embed featured video once hosting confirmed. YouTube or Vimeo recommended. Add links to other social channels once confirmed.]`
...
**Subheading:** Every engagement begins with a no-obligation call. Tell Caroline what you're working on and she'll tell you honestly whether she can help.
...
- **Phone (preferred):** +61 404 014 117
- **Email:** caro@consultcm.com.au
- **Location:** Meanjin (Brisbane), QLD — Working with organisations across Queensland and beyond.
- **LinkedIn:** Caroline Macaulay → https://www.linkedin.com/in/caroline-macaulay-91b2689b/
...
**Fields:** Name, Organisation, Email, Phone (optional), Message

**Submit button:** Send message

`[PLACEHOLDER — form is not yet active. Activate by generating a Web3Forms access key at web3forms.com using caro@consultcm.com.au, pasting it into contact.html, and removing onsubmit="return false;" and the "Form not yet active" note.]`
